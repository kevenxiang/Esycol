...
//设置标题下划线的宽度
const CGFloat kIndicatorWidth  = 10;
...
//    self.indicatorView.frame = indicatorFrame;
    ...
    //设置标题下划线的宽度
    CGRect indicatorFrame = CGRectMake(xOffset+(startItemFrame.size.width + paddingWidth - kIndicatorWidth)/2, self.scrollView.frame.size.height - 2, kIndicatorWidth, 2);
    self.indicatorView.frame = indicatorFrame;
}
...
//    self.indicatorView.frame = indicatorFrame;
    ...
    //设置标题下划线的宽度
    CGRect indicatorFrame = CGRectMake(selItemFrame.origin.x + (selItemFrame.size.width- kIndicatorWidth)/2, self.scrollView.frame.size.height - 2, kIndicatorWidth, 2);
    self.indicatorView.frame = indicatorFrame;
}
